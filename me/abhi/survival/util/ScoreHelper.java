...
public class ScoreHelper {
    ...
    public boolean hasFriendly(Player player) {
        return friendly.getEntries().contains(player.getName());
    }

    public void removeFriendly(Player player) {
    ...
    public boolean hasEnemy(Player player) {
        return enemy.getEntries().contains(player.getName());
    }

    public void remvoeEnemy(Player player) {
        enemy.removeEntry(player.getName());
    }
